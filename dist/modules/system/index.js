...
systemRouterV1.patch("/stages/update", validators_1.updateDesignationValidator, v1_controller_1.updateStage);
...
systemRouterV1.patch("/designation/add", validators_1.updateDesignationValidator, v1_controller_1.updateDesignation);
